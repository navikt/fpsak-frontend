...
import styles from './pauseBehandlingModal.less';
 ...
 */
export const PauseBehandlingModal = ({
  intl,
  handleSubmit,
  cancelEvent,
  showModal,
...
PauseBehandlingModal.propTypes = {
...
PauseBehandlingModal.defaultProps = {
  frist: null,
  originalFrist: null,
  ventearsak: null,
...
})(injectIntl(PauseBehandlingModal)));
