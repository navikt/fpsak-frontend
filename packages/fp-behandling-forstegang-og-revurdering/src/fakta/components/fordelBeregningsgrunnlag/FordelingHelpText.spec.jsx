...
describe('<FordelingHelpText>', () => {
  it('skal lage endret arbeidsforhold for permisjon', () => {
    const string = createEndretArbeidsforholdString(arbeidsforholdListe, textCase.PERMISJON, fn);
  ...
  it('skal lage endret arbeidsforhold for permisjon når permisjonTom er undefined', () => {
    const string = createEndretArbeidsforholdString(
      [{
        ...arbeidsforhold,
        permisjon: {
  ...
  it('skal lage endret arbeidsforhold for gradering', () => {
    const string = createEndretArbeidsforholdString(arbeidsforholdListe, textCase.GRADERING, fn);
  ...
  it('skal lage endret arbeidsforhold for refusjon', () => {
    const string = createEndretArbeidsforholdString(arbeidsforholdListe, textCase.REFUSJON, fn);
