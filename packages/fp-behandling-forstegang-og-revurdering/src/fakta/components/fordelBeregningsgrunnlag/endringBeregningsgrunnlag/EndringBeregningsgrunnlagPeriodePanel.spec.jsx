  ...
  it('skal sette initial values', () => {
    ...
    const bgPeriode = {
      beregningsgrunnlagPrStatusOgAndel: [
        {
 andelsnr: 1, aktivitetStatus: { kode: aktivitetStatuser.ARBEIDSTAKER }, belopPrAarEtterAOrdningen: 100, arbeidsforhold,
},
        {
 andelsnr: 2, aktivitetStatus: { kode: aktivitetStatuser.ARBEIDSTAKER }, belopPrAarEtterAOrdningen: 100, arbeidsforhold,
},
        {
 andelsnr: 3, aktivitetStatus: { kode: aktivitetStatuser.ARBEIDSTAKER }, belopPrAarEtterAOrdningen: 100, arbeidsforhold,
},
        {
 andelsnr: 4, aktivitetStatus: { kode: aktivitetStatuser.ARBEIDSTAKER }, belopPrAarEtterAOrdningen: 1000, arbeidsforhold,
},
        {
 andelsnr: 5, aktivitetStatus: { kode: aktivitetStatuser.ARBEIDSTAKER }, belopPrAarEtterAOrdningen: 1000, arbeidsforhold: arbeidsforholdEtterStp,
},
        { andelsnr: 6, aktivitetStatus: { kode: aktivitetStatuser.SELVSTENDIG_NAERINGSDRIVENDE } },
        {
 andelsnr: 7, aktivitetStatus: { kode: aktivitetStatuser.ARBEIDSTAKER }, arbeidsforhold: arbeidsforhold2, belopPrAarEtterAOrdningen: 40000,
},
