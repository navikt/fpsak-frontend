...
export const getProsessStegLocation = (location) => (prosessSteg) => getLocationWithQueryParams(location, { punkt: prosessSteg });
...
export const getLocationWithDefaultProsessStegAndFakta = (location) => (
