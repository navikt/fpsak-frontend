...
import { buildInitialValues, transformValues } from './BehandleKlageNkFormNy';

describe('<BehandleKlageNkFormNy>', () => {
  ...
  it('skal ikke sende medhold årsak når klagevurdering er stadfestet', () => {
