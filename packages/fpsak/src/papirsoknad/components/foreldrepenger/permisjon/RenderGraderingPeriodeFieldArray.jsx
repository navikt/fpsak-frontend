          ...
          <Column xs="12" className={index !== (fields.length - 1) ? styles.notLastRow : ''}>
            <FlexContainer wrap>
              <FlexRow alignItemsToFlexEnd>
                <FlexColumn>
                  <div
                    className={fieldStyle(periodeForGraderingError[index], errors[index], meta.submitFailed, styles.inputfieldMedFeil, '')}
                  >
                    <SelectField
                ...
                <FlexColumn>
                  <div
                    className={fieldStyle(fomError[index], errors[index], meta.submitFailed, styles.datefieldMedFeil, '')}
                  >
                    <DatepickerField
                ...
                <FlexColumn>
                  <div
                    className={fieldStyle(tomError[index], errors[index], meta.submitFailed, styles.datefieldMedFeil, '')}
                  >
                    <DatepickerField
