...
const faktaPanelDefinisjoner = [{
  ...
  showComponent: () => false,
  getData: ({
    soknad, personopplysninger, inntektArbeidYtelse,
  }) => ({
    soknad, personopplysninger, inntektArbeidYtelse,
  }),
}, {
  ...
  getData: ({ soknad, personopplysninger }) => ({
    isForeldrepengerFagsak: true, soknad, personopplysninger,
  }),
}, {
  ...
  endpoints: [fpBehandlingApi.FAMILIEHENDELSE, fpBehandlingApi.FAMILIEHENDELSE_ORIGINAL_BEHANDLING, fpBehandlingApi.SOKNAD_ORIGINAL_BEHANDLING],
  ...
  aksjonspunkterCodes: [aksjonspunktCodes.MANUELL_KONTROLL_AV_OM_BRUKER_HAR_ALENEOMSORG, aksjonspunktCodes.MANUELL_KONTROLL_AV_OM_BRUKER_HAR_OMSORG],
  endpoints: [],
  ...
  aksjonspunkterCodes: [aksjonspunktCodes.AVKLAR_UTTAK, aksjonspunktCodes.AVKLAR_FØRSTE_UTTAKSDATO,
    aksjonspunktCodes.ANNEN_FORELDER_IKKE_RETT_OG_LØPENDE_VEDTAK, aksjonspunktCodes.AVKLAR_ANNEN_FORELDER_RETT,
    aksjonspunktCodes.MANUELL_AVKLAR_FAKTA_UTTAK, aksjonspunktCodes.OVERSTYR_AVKLAR_FAKTA_UTTAK],
  endpoints: [fpBehandlingApi.UTTAK_KONTROLLER_FAKTA_PERIODER, fpBehandlingApi.FAKTA_ARBEIDSFORHOLD,
    fpBehandlingApi.FAMILIEHENDELSE],
  renderComponent: (props) => <UttakFaktaIndex {...props} />,
  showComponent: ({ personopplysninger, ytelsefordeling }) => ytelsefordeling && ytelsefordeling.endringsdato !== undefined && personopplysninger !== null
