...
import { BehandlingsprosessInnsynContainer } from './BehandlingsprosessInnsynContainer';

describe('BehandlingsprosessInnsynContainer', () => {
  it('skal rendre komponent uten feil', () => {
    ...
    expect(wrapper.find(BehandlingsprosessInnsynIndex)).to.have.length(1);
  });
});
