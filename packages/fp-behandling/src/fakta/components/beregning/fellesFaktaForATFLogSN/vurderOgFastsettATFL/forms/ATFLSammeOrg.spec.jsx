...
describe('<ATFLSammeOrg>', () => {
  it('skal ikke vise tekst når man ikke har tilfelle', () => {
    const wrapper = shallow(<ATFLSammeOrgTekst
      tilfeller={[faktaOmBeregningTilfelle.VURDER_MOTTAR_YTELSE]}
  ...
  it('skal vise tekst når man har tilfelle uten inntektsmelding', () => {
    const wrapper = shallow(<ATFLSammeOrgTekst
      tilfeller={[faktaOmBeregningTilfelle.VURDER_MOTTAR_YTELSE, faktaOmBeregningTilfelle.VURDER_AT_OG_FL_I_SAMME_ORGANISASJON]}
      manglerInntektsmelding
    />);
