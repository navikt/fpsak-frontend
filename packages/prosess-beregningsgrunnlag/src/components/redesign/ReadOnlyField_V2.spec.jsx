...
import ReadOnlyField2 from './ReadOnlyField_V2';

describe('ReadOnlyField2', () => {
  it('skal vise feltverdi', () => {
    const wrapper = shallow(<ReadOnlyField2 label="Dette er en test" input={{ value: '123' }} isEdited={false} />);
  ...
  it('skal vise feltverdi som editert med endret info', () => {
    const wrapper = shallow(<ReadOnlyField2 label="Dette er en test" input={{ value: '123' }} endrettekst="EndretText" />);
    const flexContainer = wrapper.find('FlexContainer');
    expect(flexContainer).to.have.length(1);
    expect(flexContainer.find('EditedIconV2')).to.have.length(1);
  ...
  it('skal ikke vise label når verdi er tom', () => {
    const wrapper = shallow(<ReadOnlyField2 label="Dette er en test" input={{ value: '' }} isEdited={false} />);
