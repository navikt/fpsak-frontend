...
import NaturalytelsePanel2, { createNaturalytelseTableData } from './NaturalytelsePanel_V2';
...
describe('<NaturalytelsePanel2>', () => {
  it('Skal teste for riktig antall rader', () => {
    const wrapper = shallowWithIntl(<NaturalytelsePanel2
