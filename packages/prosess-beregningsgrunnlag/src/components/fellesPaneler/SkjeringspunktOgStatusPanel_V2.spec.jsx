...
import SkjeringspunktOgStatusPanel2, { RADIO_GROUP_FIELD_DEKNINGSGRAD_NAVN, SkjeringspunktOgStatusPanelImpl2 } from './SkjeringspunktOgStatusPanel_V2';
...
describe('<SkjeringspunktOgStatusPanel2>', () => {
  it('Skal teste at komponenten renderer riktig skjeringstidspunkt', () => {
    const wrapper = shallow(<SkjeringspunktOgStatusPanelImpl2
  ...
  it('Skal teste buildInitialValues når ingen aksjonspunkt', () => {
    ...
    const initialValues = SkjeringspunktOgStatusPanel2.buildInitialValues(dekningsgradFraSoknad, gjeldendeAksjonspunkter);
