...
import { isBehandlingInSync } from './selectors/klageBehandlingSelectors';
import { fetchBehandling as fetchBehandlingActionCreator, getBehandlingIdentifier } from './duckKlage';

export class FpKlageBehandlingResolver extends Component {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(FpKlageBehandlingResolver);
